    ...
    <div class=" flex flex-wrap md:flex-col md:space-y-3 xl:flex-row justify-between xl:justify-around items-center ">
        ...
        <div class="flex items-center md:order-2 ">
            ...
            <div class="hidden justify-center items-center w-full md:flex md:w-auto md:order-1 " id="mobile-menu-2">
                <ul class="flex flex-col mt-4 md:flex-row  md:-mt-4 md:text-sm md:font-medium xl:mr-12 @guest xl:mr-36 @endguest  my-2 xl:my-0">
                    ...
                    <li class="mx-8">
                        ...
                        <a href="{{ route($item->route) }}"
                            class="block py-2 pl-3 pr-4 font-Alhurra1 {{ $item->active ? " text-primary-500
                    ...
                    <li class="mx-8  md:hidden">
                        ...
                        {{-- Has no submenu --}}
                        <a href="{{ route($item->route) }}"
                            class="block py-2 pl-3 pr-4 {{ $item->active ? 'text-primary-500 border-primary-100' : 'text-gray-700 hover:bg-gray-100 rounded-lg border-gray-100 hover:scale-110 duration-200 ' }} border-b-2 ">
                            {{ $item->name }}
                        </a>
                        @endif
                    </li>
            ...
            <div class="hidden justify-center items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                ...
                <ul class="flex flex-col mt-4 md:flex-row md:-mt-4 xl:mr-32 md:text-sm md:font-medium ">
