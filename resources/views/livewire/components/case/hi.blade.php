<div>
    <div class="rounded-xl border-2 border-primary-100 hover:shadow-lg hover:border-primary-500 group duration-300 ">
        {{-- case Image --}}
        <div class="pt-3 px-3">
        ...
        {{-- title + more info --}}
        <div class="p-6">
            <h5 class="text-center font-bold group-hover:text-primary-700 text-3xl md:text-xl mb-2"> {{ $event->title }}
            </h5>
            <div class="xs:28">
                <p class="text-gray-500 text-medium font-bold mb-4">
                    {{ $event->getLimit('description') }}
                    {{-- more info button --}}
                    <button class="text-primary-500 font-bold duration-300 mb-4" type="button"
