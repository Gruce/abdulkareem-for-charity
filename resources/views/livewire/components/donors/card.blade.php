        ...
        <div
            ...
            <div class="grid grid-cols-5 mb-5">
                <div class="col-span-2 flex flex-col">
                    <img src="{{ asset($photo ?? 'img/user.png') }}" alt=""
                ...
                <div class="col-span-3">
                    ...
                    <h3 class="mt-2 font-Kufi text-center text-base @if($type == 4) hidden @endif">@if($type == 1) طالب
                        @elseif($type == 2) تدريسي @else موظف @endif</h3>
                </div>
            </div>
