<nav class=" border-gray-200 px-2 py-4 sm:px-4 rounded">
    <div class=" flex flex-wrap items-center justify-between px-16 py-4">
        <a href="#" class="flex items-center">
            <img src="/docs/images/logo.svg" class="h-6 mr-3 sm:h-9" alt="">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">صندوق الأستاذ عبد
                الكريم</span>
        </a>
