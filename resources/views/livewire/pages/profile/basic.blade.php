        ...
        <form action="#" class="flex flex-col space-y-8" wire:submit.prevent="edit">
            ...
            <div class="form-item">
                ...
                <input wire:model="name" type="text" value="{{ $name }}"
                    class="border border-primary-400 text-sm focus:ring-primary-600 focus:border-primary-500 w-1/2 block p-2.5 rounded-md mt-2">
                @error('name')
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="form-item w-full">
                    ...
                    <input wire:model="email" type="text" id="email"
                        class="border border-primary-400  text-sm focus:ring-primary-600 focus:border-primary-500 block w-1/2 p-2.5 mt-2 rounded-md">
                    @error('email')
                        <span class="text-red-500 error">{{ $message }}</span>
                    @enderror
                </div>
