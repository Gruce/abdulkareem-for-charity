<div>
    ...
    <div class=" bg-[url('/img/ppp.JPG')]  bg-cover   bg-no-repeat bg-center bg-fixed max-w-9xl">
    ...
    {{-- <div id=" animation-carousel"
        class="relative max-w-lg mr-9 bg-gradient-to-r from-green-500 via-green-300 to-green-100 md:bg-contain"
        data-carousel="static h-60">

        <div class="relative overflow-hidden rounded-lg h-65 sm:h-40 xl:h-80 2xl:h-96">

            <div class="absolute inset-0 hidden transition-all duration-200 ease-linear transform "
                data-carousel-item="">
            ...
            <div class="absolute inset-0 hidden transition-all duration-200 ease-linear transform "
                ...
                <div class="absolute block w-full text-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <button type="button"
                        class="  text-black   transition ease-in-out delay-170  hover:-translate-y-1 hover:scale-110 hover:text-3xl focus:ring-4 focus:outline-none font-medium rounded-lg text-2xl text-w-4xl px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <button type="button"
            ...
            data-carousel-prev="">
            <span
                class="inline-flex items-center justify-center w-8 h-8 bg-gray-300 rounded-full sm:w-10 sm:h-10 bg-gray/30 dark:bg-gray-800/30 group-hover:bg-gray/50 dark:group-hover:bg-gray-800/60 group-focus:ring-2 group-focus:ring-gray dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                <svg class="w-5 h-5 text-gray sm:w-6 sm:h-6 dark:text-gray-800" fill="none" stroke="currentColor"
    ...
    <div class="flex justify-center   grid-cols-3 gap-4 bg-white ">
        <div class="text-center p-9">
            <a href="#">
                <i
                    class="mb-3 bg-white rounded-full shadow-lg sm:text-2xl md:text-3xl lg:text-4xl sh-full hover:bg-gradient-to-r from-green-400 to-blue-200 p-7 fa-solid fa-hand-holding-dollar"></i>
        ...
        <div class="text-center p-9">
            <a href="#">
                <i
                    class="mb-3 bg-white rounded-full shadow-lg sh-full hover:bg-gradient-to-r from-green-400 to-blue-200 p-7 sm:text-2xl md:text-3xl lg:text-4xl fa-solid fa-handshake-simple"></i>
        ...
        <div class="text-center p-9">
            <a href="#">
                <i
                    class="mb-3 bg-white rounded-full shadow-lg sm:text-2xl sh-full hover:bg-gradient-to-r from-green-400 to-blue-200 p-7 md:text-3xl lg:text-4xl fa-solid fa-hand-holding-heart"></i>
