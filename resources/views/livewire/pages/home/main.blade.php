<div>
    <div class="container mx-auto grid grid-cols-2 grid-rows-8">
        ...
        {{-- Introduction --}}
        <div class="col-span-1 row-span-3 bg-tertiary-300 p-16">
        ...
        {{-- photo --}}
        <div class="col-span-1 row-span-3 bg-primary-600 relative h-[36rem]">
        ...
        {{-- information --}}
        <div class="col-span-2 row-span-1 bg-primary-600 ">@livewire('components.home.information')</div>
        
        {{-- Contect --}}
        <div class="col-span-2 row-span-4 bg-tertiary-300 text-9xl">04</div>
    </div>
