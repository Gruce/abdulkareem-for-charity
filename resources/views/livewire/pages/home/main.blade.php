<div>
    <div class="flex flex-col absolute h-screen">
        ...
        <!-- INTRO -->
        <div class="basis-4/12 grid grid-cols-1 xl:grid-cols-12 justify-between ">
            <!-- Text -->
        ...
        <div class=" basis-4/12 xl:px-20 xl:ml-8 mt-10 xl:mt-16">
            <span class="text-secondary-900 mr-2 text-4xl xl:text-6xl font-bold ">
                اخر الحالات
            </span>
            <div
        ...
        <div class=" basis-2/12  mt-10 xl:mt-16 xl:ml-16">
            <span class="text-secondary-900 text-4xl mr-2 xl:text-6xl font-bold xl:pr-20">
                نحن نعمل لأجل
            </span>
