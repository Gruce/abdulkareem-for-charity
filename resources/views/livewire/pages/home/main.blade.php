<div>
    <div class="flex flex-col container mx-auto">
        ...
        <div class="basis-4/12 grid grid-cols-1 xl:grid-cols-12 justify-between mt-10 md:mt-0 ">
            <!-- Text -->
            <div class=" xl:col-span-5  xl:pt-16  ">
        ...
        <div class=" basis-4/12  mt-10 xl:mt-16">
            <span class="text-secondary-900 text-4xl xl:text-6xl  font-bold pr-4  ">
                احدث الحالات
            </span>
            <div
            class="my-6 xl:my-20  grid  grid-cols-1 md:grid-cols-2  xl:grid-cols-4 gap-16 xl:gap-2 ">
        ...
        {{--Work for--}}
        <div class=" basis-2/12  mt-10 xl:mt-16 ">
            <span class="text-secondary-900 text-4xl xl:text-6xl  font-bold pr-4  ">
                نحن نعمل لأجل
            </span>
