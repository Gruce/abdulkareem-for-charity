<div>
    <div
        ...
        <div class="flex items-center justify-around p-3 space-x-3 border-t-2">
            <a rel="noopener noreferrer" target="_blank" href="mailto:{{$team->email}}" title="Email" class="">
                <i class="fa-solid fa-envelope"></i>
            </a>

            <a rel="noopener noreferrer" target="_blank" href="{{ $team->github }}" title="GitHub" class="">
