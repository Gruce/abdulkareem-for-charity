...
<div>
    <div>
        <div class="grid grid-cols-8 px-3 md:px-4 mt-6 lg:mt-0">
            <div class="@admin col-span-8  @else col-span-8 md:col-span-5 lg:col-span-6 @endadmin p-1">@livewire('ui.search', 'title')</div>

            <div class="@admin col-span-4 md:col-span-6 @else col-span-8 md:col-span-3 lg:col-span-2 @endadmin p-1">
            ...
            <div class="col-span-4 md:col-span-2 flex item-center p-1">
                ...
                <a href="{{ route('add-case') }}"
                    class=" px-6 py-3 w-full rounded-md bg-primary-600  focus:border-primary-500 focus:bg-white focus:ring-0 text-white text-sm">
