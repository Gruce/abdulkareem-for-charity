    ...
    <div class="grid rounded-lg w-full">
        ...
        <div class="flex flex-row w-full">
            ...
            <div class="grid grid-cols-1 mt-5 mx-7 w-1/2">
                <label class="w-full md:text-sm text-xs text-gray-700 text-light font-semibold">المبلغ الواصل</label>
                <input
                    class="w-full py-2 px-3 rounded-lg border-2 border-primary-500 mt-1 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent"
            ...
            <div class="w-1/2 mt-5 mx-7">
                ...
                <div class="flex items-center justify-center w-full">
                    <label
                        class="flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-200 hover:border-primary-300 rounded-lg">
                        <div class="flex flex-col items-center justify-center pt-7">
                            <i class="fa-solid fa-file-circle-plus w-10 h-10 text-gray-400 hover:text-primary-300"></i>
