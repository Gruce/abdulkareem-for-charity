...
<div class="flex h-screen items-center justify-center  mt-32 mb-32">
    <div class="grid  rounded-lg  w-full ">
      ...
      <div class="grid grid-cols-1 mt-5 mx-7">
        ...
        <input class="py-2 px-3 rounded-lg border-2 border-primary-600 mt-1 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent" type="text" />
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
        ...
        <div class="grid grid-cols-1">
          ...
          <input class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" />
        </div>
      </div>
  
      <div class="grid grid-cols-1 mt-5 mx-7">
        <label class="uppercase md:text-sm text-xs text-gray-700 text-light font-semibold">المبلغ الواصل</label>
        <input class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text"/>
      </div>
  
      <div class="grid grid-cols-1 mt-5 mx-7">
        <label class="uppercase md:text-sm text-xs text-gray-700 text-light font-semibold mb-1">ارفاق صورة</label>
          <div class='flex items-center justify-center w-full'>
              <label class='flex flex-col border-4 border-dashed border-blue-100 w-full h-32 hover:bg-blue-100 hover:border-blue-300 group rounded-lg'>
                  <div class='flex flex-col items-center justify-center pt-7'>
                    ...
                    <p class='lowercase text-sm text-gray-400 group-hover:text-gray-600 pt-1 tracking-wider'>اختر صورة</p>
                  </div>
      ...
      <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
        <button class='w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Create</button>
      </div>
