<div class=" grid grid-cols-1 xl:grid-cols-12 justify-between">
    <div class="basis-1/2 col-span-5 pt-2 xl:pr-24 ">
                    ...
                    <ul class="py-1 text-sm text-gray-700 " aria-labelledby="dropdownDefault">
                        <li>
                            <a class="block px-4 py-2 my-1 hover:bg-gray-100 text-secondary-200 group"
                                href="<?php echo e(route('edit-case', ['case_id' => $event->id])); ?>">
                                <span>تعديل </span>
                                <i
                        ...
                        <li>
                            <button wire:click="confirm(<?php echo e($event->id); ?>)"
        ...
        <div class="w-full  text-center mt-5 p-2 xl:mt-8">
            ...
            <div class="flex justify-between px-3 mt-2 text-xl text-secondary-200">
                <div>
                    <h3> <?php if($event->received_price): ?> <?php echo money($event->received_price, 'IQD'); ?> <?php else: ?> <?php echo money(0, 'IQD'); ?> <?php endif; ?> </h3>
                    <p class="text-sm">المدفوع</p>
                </div> 
                <div class="px-1.5"><?php echo e(round(($event->received_price * 100) / $event->target)); ?>%</div>
                <div>
                    <h3><?php echo money($event->target, 'IQD'); ?></h3>
    ...
    <div class="basis-1/2 xl:col-span-7 rounded-3xl">
        <img src="<?php echo e(asset($image_path ?? 'img/caseImage.webp')); ?>"
            class="w-3/4 h-auto my-20 border-4 border-primary-500 rounded-3xl m-auto">
    </div>
</div>
<?php /**PATH /www/wwwroot/abdulkareem-for-charity/resources/views/livewire/pages/cases/case-page.blade.php ENDPATH**/ ?>