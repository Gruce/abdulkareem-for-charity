...
} elseif ($_instance->childHasBeenRendered('l2515396783-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2515396783-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2515396783-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2515396783-0');
} else {
    $response = \Livewire\Livewire::mount('pages.home.info');
    $html = $response->html();
    $_instance->logRenderedChild('l2515396783-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l2515396783-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2515396783-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2515396783-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2515396783-2');
} else {
    $response = \Livewire\Livewire::mount('pages.home.activities');
    $html = $response->html();
    $_instance->logRenderedChild('l2515396783-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
</div><?php /**PATH /www/wwwroot/abdulkareem-for-charity/resources/views/livewire/pages/home/main.blade.php ENDPATH**/ ?>