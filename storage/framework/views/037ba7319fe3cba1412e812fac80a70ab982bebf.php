...
} elseif ($_instance->childHasBeenRendered('l3767367084-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3767367084-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3767367084-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3767367084-0');
} else {
    $response = \Livewire\Livewire::mount('pages.committee.add');
    $html = $response->html();
    $_instance->logRenderedChild('l3767367084-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH C:\Users\AL Laith Group\OneDrive\Documents\GitHub\abdulkareem-for-charity\resources\views/livewire/pages/committee/main.blade.php ENDPATH**/ ?>