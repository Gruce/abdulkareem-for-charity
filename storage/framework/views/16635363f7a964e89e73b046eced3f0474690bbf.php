...
} elseif ($_instance->childHasBeenRendered('l2974493253-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2974493253-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2974493253-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2974493253-0');
} else {
    $response = \Livewire\Livewire::mount('pages.home.info');
    $html = $response->html();
    $_instance->logRenderedChild('l2974493253-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l2974493253-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2974493253-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2974493253-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2974493253-2');
} else {
    $response = \Livewire\Livewire::mount('pages.home.activities');
    $html = $response->html();
    $_instance->logRenderedChild('l2974493253-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
