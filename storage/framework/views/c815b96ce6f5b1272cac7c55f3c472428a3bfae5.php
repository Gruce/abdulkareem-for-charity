...
} elseif ($_instance->childHasBeenRendered('l613908749-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l613908749-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l613908749-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l613908749-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'name');
    $html = $response->html();
    $_instance->logRenderedChild('l613908749-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH C:\Users\AL Laith Group\OneDrive\Documents\GitHub\abdulkareem-for-charity\resources\views/livewire/pages/donors/main.blade.php ENDPATH**/ ?>