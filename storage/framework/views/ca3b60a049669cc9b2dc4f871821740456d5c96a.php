...
<<<<<<<< HEAD:storage/framework/views/b1a24ac1cb5abb25f5283285f87343e67483c3a8.php
} elseif ($_instance->childHasBeenRendered('l219089309-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l219089309-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l219089309-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l219089309-0');
} else {
    $response = \Livewire\Livewire::mount('pages.home.info');
    $html = $response->html();
    $_instance->logRenderedChild('l219089309-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
========
} elseif ($_instance->childHasBeenRendered('l2992232681-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2992232681-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2992232681-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2992232681-0');
} else {
    $response = \Livewire\Livewire::mount('pages.home.info');
    $html = $response->html();
    $_instance->logRenderedChild('l2992232681-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
>>>>>>>> master:storage/framework/views/ca3b60a049669cc9b2dc4f871821740456d5c96a.php
}
echo $html;
?>
        </div>
...
<<<<<<<< HEAD:storage/framework/views/b1a24ac1cb5abb25f5283285f87343e67483c3a8.php
} elseif ($_instance->childHasBeenRendered('l219089309-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l219089309-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l219089309-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l219089309-2');
} else {
    $response = \Livewire\Livewire::mount('pages.home.activities');
    $html = $response->html();
    $_instance->logRenderedChild('l219089309-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
========
} elseif ($_instance->childHasBeenRendered('l2992232681-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2992232681-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2992232681-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2992232681-2');
} else {
    $response = \Livewire\Livewire::mount('pages.home.activities');
    $html = $response->html();
    $_instance->logRenderedChild('l2992232681-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
>>>>>>>> master:storage/framework/views/ca3b60a049669cc9b2dc4f871821740456d5c96a.php
}
echo $html;
?>
...
<?php /**PATH E:\github\abdulkareem-for-charity\resources\views/livewire/pages/home/main.blade.php ENDPATH**/ ?>
========
</div><?php /**PATH E:\Github Repositories\Elites Projects\abdulkareem-for-charity\resources\views/livewire/pages/home/main.blade.php ENDPATH**/ ?>
>>>>>>>> master:storage/framework/views/ca3b60a049669cc9b2dc4f871821740456d5c96a.php
