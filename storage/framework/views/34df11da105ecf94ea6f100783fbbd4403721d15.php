...
} elseif ($_instance->childHasBeenRendered('l2565828713-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2565828713-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2565828713-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2565828713-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'title');
    $html = $response->html();
    $_instance->logRenderedChild('l2565828713-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
...
</div><?php /**PATH E:\github\abdulkareem-for-charity\resources\views/livewire/pages/cases/main.blade.php ENDPATH**/ ?>