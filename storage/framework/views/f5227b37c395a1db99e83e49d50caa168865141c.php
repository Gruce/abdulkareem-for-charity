...
} elseif ($_instance->childHasBeenRendered('l1079125859-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1079125859-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1079125859-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1079125859-0');
} else {
    $response = \Livewire\Livewire::mount('pages.home.info');
    $html = $response->html();
    $_instance->logRenderedChild('l1079125859-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l1079125859-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1079125859-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1079125859-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1079125859-2');
} else {
    $response = \Livewire\Livewire::mount('pages.home.activities');
    $html = $response->html();
    $_instance->logRenderedChild('l1079125859-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
</div><?php /**PATH C:\Users\AL Laith Group\OneDrive\Documents\GitHub\abdulkareem-for-charity\resources\views/livewire/pages/home/main.blade.php ENDPATH**/ ?>