...
<<<<<<<< HEAD:storage/framework/views/8db63135d2b01ae829e507ac160b958410ab7d3f.php
} elseif ($_instance->childHasBeenRendered('Yc8Jtqp')) {
    $componentId = $_instance->getRenderedChildComponentId('Yc8Jtqp');
    $componentTag = $_instance->getRenderedChildComponentTagName('Yc8Jtqp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Yc8Jtqp');
} else {
    $response = \Livewire\Livewire::mount('components.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('Yc8Jtqp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
========
} elseif ($_instance->childHasBeenRendered('95QyyOx')) {
    $componentId = $_instance->getRenderedChildComponentId('95QyyOx');
    $componentTag = $_instance->getRenderedChildComponentTagName('95QyyOx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('95QyyOx');
} else {
    $response = \Livewire\Livewire::mount('components.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('95QyyOx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
>>>>>>>> master:storage/framework/views/a3c0909088fca57081b7b943d79fb5994853d703.php
}
echo $html;
?></div>
...
<<<<<<<< HEAD:storage/framework/views/8db63135d2b01ae829e507ac160b958410ab7d3f.php
<?php /**PATH E:\github\abdulkareem-for-charity\resources\views/layouts/app.blade.php ENDPATH**/ ?>
========
<?php /**PATH C:\Github Repositories\Elites Projects\abdulkareem-for-charity\resources\views/layouts/app.blade.php ENDPATH**/ ?>
>>>>>>>> master:storage/framework/views/a3c0909088fca57081b7b943d79fb5994853d703.php
