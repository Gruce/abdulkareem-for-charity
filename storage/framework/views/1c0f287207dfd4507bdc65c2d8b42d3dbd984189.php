...
} elseif ($_instance->childHasBeenRendered('l1117385705-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1117385705-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1117385705-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1117385705-0');
} else {
    $response = \Livewire\Livewire::mount('pages.profile.basic', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('l1117385705-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('l1117385705-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1117385705-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1117385705-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1117385705-1');
} else {
    $response = \Livewire\Livewire::mount('pages.profile.student-info', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('l1117385705-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
</div><?php /**PATH E:\github\abdulkareem-for-charity\resources\views/livewire/pages/profile/main.blade.php ENDPATH**/ ?>