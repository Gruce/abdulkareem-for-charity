...
} elseif ($_instance->childHasBeenRendered('7AVZsGD')) {
    $componentId = $_instance->getRenderedChildComponentId('7AVZsGD');
    $componentTag = $_instance->getRenderedChildComponentTagName('7AVZsGD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7AVZsGD');
} else {
    $response = \Livewire\Livewire::mount('components.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('7AVZsGD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
...
<?php /**PATH E:\Github Repositories\Elites Projects\abdulkareem-for-charity\resources\views/layouts/app.blade.php ENDPATH**/ ?>