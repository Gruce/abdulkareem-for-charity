...
} elseif ($_instance->childHasBeenRendered('l294119539-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l294119539-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l294119539-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l294119539-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'title');
    $html = $response->html();
    $_instance->logRenderedChild('l294119539-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
