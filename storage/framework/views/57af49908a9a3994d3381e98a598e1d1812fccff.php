...
} elseif ($_instance->childHasBeenRendered('l1208161233-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1208161233-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1208161233-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1208161233-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'name');
    $html = $response->html();
    $_instance->logRenderedChild('l1208161233-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /www/wwwroot/abdulkareem-for-charity/resources/views/livewire/pages/donors/main.blade.php ENDPATH**/ ?>