...
} elseif ($_instance->childHasBeenRendered('l3065836292-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3065836292-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3065836292-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3065836292-0');
} else {
    $response = \Livewire\Livewire::mount('pages.home.info');
    $html = $response->html();
    $_instance->logRenderedChild('l3065836292-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l3065836292-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3065836292-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3065836292-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3065836292-2');
} else {
    $response = \Livewire\Livewire::mount('pages.home.activities');
    $html = $response->html();
    $_instance->logRenderedChild('l3065836292-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
