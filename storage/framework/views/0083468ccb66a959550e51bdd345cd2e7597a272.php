...
} elseif ($_instance->childHasBeenRendered('l1352712968-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1352712968-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1352712968-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1352712968-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'title');
    $html = $response->html();
    $_instance->logRenderedChild('l1352712968-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
...
</div><?php /**PATH /www/wwwroot/abdulkareem-for-charity/resources/views/livewire/pages/cases/main.blade.php ENDPATH**/ ?>