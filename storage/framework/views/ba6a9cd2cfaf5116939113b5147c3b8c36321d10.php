        ...
        <div class="basis-1/4 grid lg:grid-cols-12 justify-between mt-12 lg:mt-20">
            ...
            <div class="basis-1/2 lg:col-span-5 xl:mt-32  text-right md:px-8">
                ...
                <p class="leading-10 mt-10 text-base md:text-xl xl:text-2xl text-gray-700 font-Alhurrareg px-2  ">
                    ...
                    وسيظهر عدد اسهمه في صفحة<a href="<?php echo e(route('donors')); ?>" class="text-primary-500"> المتبرعين </a>
                    سعر السهم في الصندوق هو 2000 د.ع ثابت
                    ويتم شراء الأسهم من خلال صفحة
                    <a href="<?php echo e(route('donate')); ?>" class="text-primary-500">التبرع</a>
                    .
                </p>
...
<?php /**PATH C:\Users\AL Laith Group\OneDrive\Documents\GitHub\abdulkareem-for-charity\resources\views/livewire/pages/about/main.blade.php ENDPATH**/ ?>