...
} elseif ($_instance->childHasBeenRendered('l2408946766-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2408946766-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2408946766-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2408946766-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'name');
    $html = $response->html();
    $_instance->logRenderedChild('l2408946766-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
