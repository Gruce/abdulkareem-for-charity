...
} elseif ($_instance->childHasBeenRendered('l274427564-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l274427564-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l274427564-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l274427564-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'title');
    $html = $response->html();
    $_instance->logRenderedChild('l274427564-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
...
</div><?php /**PATH C:\Github Repositories\Elites Projects\abdulkareem-for-charity\resources\views/livewire/pages/cases/main.blade.php ENDPATH**/ ?>