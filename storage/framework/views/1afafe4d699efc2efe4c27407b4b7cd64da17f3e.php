...
<<<<<<<< HEAD:storage/framework/views/9b96473fe186fb3d91cb10669a88dc76a2b7f355.php
} elseif ($_instance->childHasBeenRendered('l1920863660-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1920863660-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1920863660-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1920863660-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'name');
    $html = $response->html();
    $_instance->logRenderedChild('l1920863660-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
========
} elseif ($_instance->childHasBeenRendered('l2583203725-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2583203725-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2583203725-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2583203725-0');
} else {
    $response = \Livewire\Livewire::mount('ui.search', 'name');
    $html = $response->html();
    $_instance->logRenderedChild('l2583203725-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
>>>>>>>> master:storage/framework/views/1afafe4d699efc2efe4c27407b4b7cd64da17f3e.php
}
echo $html;
?>
                </div>
...
<<<<<<<< HEAD:storage/framework/views/9b96473fe186fb3d91cb10669a88dc76a2b7f355.php
<?php /**PATH E:\github\abdulkareem-for-charity\resources\views/livewire/pages/donors/main.blade.php ENDPATH**/ ?>
========
<?php /**PATH C:\Github Repositories\Elites Projects\abdulkareem-for-charity\resources\views/livewire/pages/donors/main.blade.php ENDPATH**/ ?>
>>>>>>>> master:storage/framework/views/1afafe4d699efc2efe4c27407b4b7cd64da17f3e.php
